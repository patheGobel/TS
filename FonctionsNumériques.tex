...
\begin{document}
\maketitle
\section*{\underline{\textbf{\textcolor{red}{A. LIMITES-CONTINUITÉ-DÉRIVABILITÉ}}}}
...
\begin{enumerate}
    ...
    \item Quelle est la fonction réciproque \( f^{-1} \) de la fonction \( f \) ?
...
\section*{\underline{\textbf{\textcolor{red}{B.ÉTUDES DE FONCTIONS}}}}
\end{document}
