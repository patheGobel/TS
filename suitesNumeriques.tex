...
\textbf{\underline{\correction}}
\section*{\underline{\textbf{\textcolor{red}{IV. Suites Minorée-Majorée-Bornée-Convergente-Divergente-adjacents}}}}
...
\begin{itemize}
    ...
    \item Si $(u_n)_n$ est croissante et non majorée, alors $\lim_{n \to \infty} u_n = +\infty$.
    \item Si $(u_n)_n$ est décroissante et non minorée, alors $\lim_{n \to \infty} u_n = -\infty$.
\end{itemize}
\textbf{\underline{\exemple}}
...
\textbf{\underline{\exemple}}
\textbf{\underline{\solution}}
\subsection*{\underline{\textbf{\textcolor{red}{6. Suites adjacents}}}}
\textbf{\underline{\exemple}}
\textbf{\underline{\solution}}
\subsection*{\underline{\textbf{\textcolor{red}{V. Suite arithmétiques}}}}
