...
\subsection*{\underline{\textbf{\textcolor{red}{Exemple de deux suites adjacentes}}}}

\textbf{\underline{Définition des suites}}\\
Considérons les deux suites suivantes définies par récurrence pour tout $n \in \mathbb{N}$ :
\[
\begin{cases}
u_0 = 1, & v_0 = 2, \\
